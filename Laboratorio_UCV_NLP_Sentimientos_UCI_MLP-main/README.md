...
## 25. Preguntas de Análisis y Respuestas
...
*   **Vectorizar:** Es el paso posterior donde esos tokens abstractos se convierten en números reales. El resultado final es una matriz numérica que la red neuronal puede multiplicar por sus pesos sinápticos durante el entrenamiento.
...
*   **Análisis:** La red compacta $(64, 32)$ demostró ser la más robusta para el negocio al maximizar la sensibilidad (*Recall* de **84.38%**). Incrementar la profundidad a tres capas saturó el modelo reduciendo drásticamente su rendimiento general, lo que demuestra que más capas no implican una mejora lineal en representaciones estadísticas densas.
...
Por estas razones, la ingeniería de software moderna ha migrado hacia el uso de arquitecturas que generan embeddings contextuales dinámicos, donde, tal como describen **Achiam et al. (2024)** en los reportes técnicos de modelos avanzados, el significado de cada palabra se redefine matemáticamente según la posición y relación absoluta con las demás palabras de la oración.
